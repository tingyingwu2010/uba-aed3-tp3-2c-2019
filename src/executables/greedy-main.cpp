...
int main(){
    ...
    //TODO: resolver con tu algoritmo
//    CVRPEuristic *savingsEuristic = new SavingsEuristic(); // Instanciar clase
//    OutputCVRP *outputCVRP = savingsEuristic->execute(*inputCVRP); // Resolver y devolver OutputCVRP
